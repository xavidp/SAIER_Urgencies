...
# Libraries to allow runing processes in parallel where possible
...
my_doc <- my_doc %>% 
  body_add_par(value = "Derivacions del CUESB al SAIER (2017)", style = "capitol") %>% 
...
my_doc <- my_doc %>% 
  ...
  body_add_par(value = "Demo de Taula de dades d'Entrada. 2017", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_table(head(my_data5b), style = "Table Professional") %>%
  body_add_par(value = "Demo de Taula de dades d'Entrada. 2017", style = "table title") 
