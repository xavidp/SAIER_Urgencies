...
webshot(file.path(getwd(), htmlpath, "2017.pt.SituacioAdministrativa.html"),
        file=file.path(getwd(), imgpath, "2017.pt.SituacioAdministrativa.png"),
...
my_doc <- my_doc %>% 
  ...
  body_add_break() %>% 
  body_add_par(value = "Taula XXX. 2017", style = "heading 2") %>% 
