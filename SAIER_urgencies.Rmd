...
# Plot Map Using rworldmap
  ...
  png(filename=file.path(getwd(), imgpath, "2017.worldmap.familysize.png"), width="1000", height="600")
...
```{r Derivacions CUESB -> SAIER 2017}
  ...
  # basic treemaps
    png(filename=file.path(getwd(), imgpath, "2017.treemap.nacionality.png"), width="1000", height="600")
