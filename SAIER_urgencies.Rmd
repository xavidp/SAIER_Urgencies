...
my_doc <- my_doc %>% 
  ...
  body_add_par(value = "Continguts", style = "Normal") %>% 
...
my_doc <- my_doc %>% 
  ...
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_par(value = "10 Nacionalitats més freqüents", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
...
# ggplot.2017.nacionalitat.faceted
  ...
  # =======================================================
    ...
    # Afegir contingut a l'informe en Word
my_doc <- my_doc %>% 
  body_add_par(value = "Representació gràfica", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
...
#  png(filename=file.path(getwd(), imgpath, "2017.worldmap.familysize.png"), width=1200, height=600, units="px")
  ...
  image_info(my_image)
  my_image <- image_trim(my_image)
  image_info(my_image)
  my_image_scaled <- image_scale(my_image, "2000") # width to 2000px and height proportional to keep aspect ratio
...
#  body_add_img(src = file.path(getwd(), imgpath, "2017.worldmap.familysize.png"), width = 6, height = 3, style = "centered") %>% 
  body_add_img(src = file.path(getwd(), imgpath, "2017.worldmap.familysize.png"), style = "centered") %>% 
  body_add_par("", style = "Normal") # blank paragraph
