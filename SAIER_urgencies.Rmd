...
# Plot Map Using rworldmap
  ...
  saveWidget(worldmap.2017.familysize, file=file.path(getwd(), htmlpath, "2017.worldmap.familysize.html"), selfcontained=TRUE) 

  webshot(file.path(getwd(), htmlpath, "2017.worldmap.familysize.html"),
        file=file.path(getwd(), imgpath, "2017.worldmap.familysize.png"),
        delay=0.5)
...
```{r Derivacions CUESB -> SAIER 2017}
  ...
  # basic treemaps
    png(filename=file.path(getwd(), imgpath, "treemap.2017.nacio.png"))
