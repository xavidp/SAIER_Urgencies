...
# ...........................................
# my_data7d.ft <- my_data %>% 
#       count(MesDerivacioSAIER,
#             SituacioAdministrativa,
#             wt = NULL, sort = FALSE) %>%
#   tidyr::spread(unique(MesDerivacioSAIER), unique(SituacioAdministrativa), n)
# 
# formattable(my_data7d.ft, list(area(col = c(a:c))
...
colnames(my_data7k.t) <- c("Nombre de vegades", "Casos")
