...
#  png(filename=file.path(getwd(), imgpath, "2017.worldmap.familysize.png"))
  # Plot as svg
  svglite(file.path(getwd(), imgpath, "2017.worldmap.familysize.svg"), width = 10, height = 7)
  ...
  # Redo as png
  png(file.path(getwd(), imgpath, "2017.worldmap.familysize.png"), width=1200, height=600, units="px")
  worldmap.2017.familysize
  dev.off()
