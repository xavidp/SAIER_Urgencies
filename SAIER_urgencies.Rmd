...
my_doc <- my_doc %>% 
  ...
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_img(src = file.path(getwd(), imgpath, "2017.pt.SituacioAdministrativa.t.png"), width = 5, height = 4, style = "centered") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
...
my_doc <- my_doc %>% 
  body_add_break() %>% 
  body_add_par(value = "Origen Derivació a CUESB", style = "heading 1") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_par(value = "Resum", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_img(src = file.path(getwd(), imgpath, "2017.treemap.nacionality.png"), width = 6, height = 3, style = "centered") %>% 
...
my_doc <- my_doc %>% 
  body_add_break() %>% 
  body_add_par(value = "Evolució mensual de les derivacions del SAIER al CUESB", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_img(src = file.path(getwd(), imgpath, "2017.treemap.nacionality.png"), width = 6, height = 3, style = "centered") %>% 
...
my_doc <- my_doc %>% 
  ...
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_par(value = "Percentatge de casos en que l'usuari torna una 2a vegada o més", style = "heading 2") %>% 
  body_add_par("", style = "Normal") %>% # blank paragraph
  body_add_img(src = file.path(getwd(), imgpath, "2017.treemap.nacionality.png"), width = 6, height = 3, style = "centered") %>% 
